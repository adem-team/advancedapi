...
use ptrnov\fusionchart\Chart;
	...
	$weeklySsalesDays= Chart::Widget([
		'urlSource'=> url::base().'/dashboard/foodtown/weekly-sales-days',
		...
		'type'=>'mscolumn2d',//msline//'bar3d',//'gantt',				//Chart Type 
		'renderid'=>'mscolumn3d-sss-weekly-sales-day',					//unix name render
		'autoRender'=>true,
		'width'=>'100%',
		'height'=>'350px',
		'chartOption'=>[				
	...
	<div class="col-sm-12 col-md-12 col-lg-12" style="margin-top:10px">
		<div class="w3-card-2 w3-round w3-white w3-center">
				<div class="panel-heading">
					<div class="row">
						<div style="min-height:350px"><div style="height:350px"><?=$weeklySsalesDays?></div></div><div class="clearfix"></div>
					</div>
				</div>	
			</div>				
		<?php
