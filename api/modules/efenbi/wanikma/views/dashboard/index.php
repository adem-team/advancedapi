...
$this->sideCorp = 'F&B - Wanikma';                      					/* Title Select Company pada header pasa sidemenu/menu samping kiri */	
$this->sideMenu = 'efenbi_wanikma';                                    		/* kd_menu untuk list menu pada sidemenu, get from table of database */
...
$this->params['breadcrumbs'][] = $this->title;                      		/* belum di gunakan karena sudah ada list sidemenu, on plan next*/
	...
	$items=[
		[
			'label'=>'<i class="glyphicon glyphicon-home"></i> Sales-Wanikma','content'=>
			$_indexSalesDay.
			$_indexSalesWeekHour.
			$_indexSalesWeek.						
			$_indexSalesYear.
