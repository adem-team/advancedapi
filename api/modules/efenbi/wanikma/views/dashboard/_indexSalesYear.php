...
use ptrnov\fusionchart\Chart;
	...
	$mslineSalesYear= Chart::Widget([
		'urlSource'=> url::base().'/dashboard/foodtown/trans-years-all',
		...
		'renderid'=>'msline-sss-sales-year',								//unix name render
		'autoRender'=>true,
		'width'=>'100%',
		'height'=>'400px',
		'chartOption'=>[				
	...
	<div class="col-sm-12 col-md-12 col-lg-12" style="margin-top:10px">
		<div class="w3-card-2 w3-round w3-white w3-center">
				<div class="panel-heading">
					<div class="row">
						<div style="min-height:400px"><div style="height:400px"><?=$mslineSalesYear?></div></div><div class="clearfix"></div>
					</div>
				</div>	
			</div>				
		<?php
